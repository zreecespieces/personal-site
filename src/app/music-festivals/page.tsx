...
export default function MusicFestivals() {
    ...
    const years = Array.from(new Set(festivals.map(festival => festival.year)))
    ...
    // Sort all festivals from earliest to latest for the "All" option
    const allFestivalsSorted = [...festivals].sort((a, b) => {
        // First sort by year (as number)
        const yearDiff = parseInt(a.year) - parseInt(b.year);
        if (yearDiff !== 0) return yearDiff;
        
        // If same year, sort alphabetically by name
                    ...
                    <DialogContent sx={{ p: 0, position: 'relative' }}>
                        ...
                        >
                            <Typography variant="h4" fontWeight="700" gutterBottom>
                                {selectedFestival.name} <Typography component="span" variant="h5" color="primary">{selectedFestival.year}</Typography>
                            </Typography>
